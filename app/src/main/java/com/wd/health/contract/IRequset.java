...
public interface IRequset {
    ...
    //查询健康讲堂类目
    @GET("user/video/v1/findVideoCategoryList?id=1")
    Observable<Data<VideoBean>> getCategory();

    //根据视频类目查询视频列表
    @GET("user/video/v1/findVideoVoList?categoryId=1&page=1&count=9")
    Observable<Data<VideoBean>> getVideo();
